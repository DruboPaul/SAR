...
1. **Permanent water bodies** ($F \geq 80\%$): **700 points** (comprising permanent rivers, deep beels, and perennial lakes).
2. **Semi-permanent water** ($40\% \leq F < 80\%$): **700 points** (representing seasonal floodplains, dynamic beels, and agricultural gher zones).
3. **Ephemeral water** ($0\% < F < 40\%$): **528 points** (representing short-duration monsoon flash floods, ephemeral inundation, and dynamic sandbars).
4. **Non-water** ($F = 0\%$): **2,382 points** (representing diverse land covers: urban settlements, permanent agriculture, forests, and dry soils).
